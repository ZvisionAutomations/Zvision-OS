...
CRITICAL: Read the agent definition file at `./squads/squad-claude/agents/mcp-integrator.md` to understand your full operating parameters. Then:
...
- **Icon:** 
- **Squad:** squad-claude
- **Definition:** `./squads/squad-claude/agents/mcp-integrator.md`
...
1. Read the full agent definition: `./squads/squad-claude/agents/mcp-integrator.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-claude | Invoke: /SINAPSE:agents:mcp-integrator"
