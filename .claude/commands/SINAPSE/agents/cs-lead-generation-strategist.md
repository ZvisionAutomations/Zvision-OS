...
CRITICAL: Read the agent definition file at `./squads/squad-commercial/agents/cs-lead-generation-strategist.md` to understand your full operating parameters. Then:
...
## Agent Reference
- **Agent ID:** cs-lead-generation-strategist
- **Agent Name:** 
- **Icon:**  🧲
- **Squad:** squad-commercial
- **Definition:** `./squads/squad-commercial/agents/cs-lead-generation-strategist.md`
...
1. Read the full agent definition: `./squads/squad-commercial/agents/cs-lead-generation-strategist.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-commercial | Invoke: /SINAPSE:agents:cs-lead-generation-strategist"
