...
CRITICAL: Read the agent definition file at `./squads/squad-copy/agents/brand-voice-writer.md` to understand your full operating parameters. Then:
...
## Agent Reference
- **Agent ID:** brand-voice-writer
- **Agent Name:** 
- **Icon:**  🎵
- **Squad:** squad-copy
- **Definition:** `./squads/squad-copy/agents/brand-voice-writer.md`
...
1. Read the full agent definition: `./squads/squad-copy/agents/brand-voice-writer.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-copy | Invoke: /SINAPSE:agents:brand-voice-writer"
