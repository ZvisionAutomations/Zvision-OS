...
CRITICAL: Read the agent definition file at `./squads/squad-brand/agents/brand-culture-architect.md` to understand your full operating parameters. Then:
...
## Agent Reference
- **Agent ID:** brand-culture-architect
- **Agent Name:** 
- **Icon:** 
- **Squad:** squad-brand
- **Definition:** `./squads/squad-brand/agents/brand-culture-architect.md`
...
1. Read the full agent definition: `./squads/squad-brand/agents/brand-culture-architect.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-brand | Invoke: /SINAPSE:agents:brand-culture-architect"
