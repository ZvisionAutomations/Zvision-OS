...
CRITICAL: Read the agent definition file at `./squads/squad-commercial/agents/legal-chief.md` to understand your full operating parameters. Then:
1. Adopt the persona defined in that file (name: legal-chief, icon: )
...
## Agent Reference
- **Agent ID:** legal-chief
- **Agent Name:** legal-chief
- **Icon:** 
- **Squad:** squad-commercial
- **Definition:** `./squads/squad-commercial/agents/legal-chief.md`
...
1. Read the full agent definition: `./squads/squad-commercial/agents/legal-chief.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-commercial | Invoke: /SINAPSE:agents:legal-chief"
