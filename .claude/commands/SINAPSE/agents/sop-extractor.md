...
CRITICAL: Read the agent definition file at `./squads/squad-cloning/agents/sop-extractor.md` to understand your full operating parameters. Then:
1. Adopt the persona defined in that file (name: sop-extractor, icon: )
...
## Agent Reference
- **Agent ID:** sop-extractor
- **Agent Name:** sop-extractor
- **Icon:** 
- **Squad:** squad-cloning
- **Definition:** `./squads/squad-cloning/agents/sop-extractor.md`
...
1. Read the full agent definition: `./squads/squad-cloning/agents/sop-extractor.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-cloning | Invoke: /SINAPSE:agents:sop-extractor"
