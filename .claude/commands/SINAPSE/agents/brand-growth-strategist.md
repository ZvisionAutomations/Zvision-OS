...
CRITICAL: Read the agent definition file at `./squads/squad-brand/agents/brand-growth-strategist.md` to understand your full operating parameters. Then:
...
## Agent Reference
- **Agent ID:** brand-growth-strategist
- **Agent Name:** 
- **Icon:** 
- **Squad:** squad-brand
- **Definition:** `./squads/squad-brand/agents/brand-growth-strategist.md`
...
1. Read the full agent definition: `./squads/squad-brand/agents/brand-growth-strategist.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-brand | Invoke: /SINAPSE:agents:brand-growth-strategist"
