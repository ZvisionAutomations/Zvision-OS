...
CRITICAL: Read the agent definition file at `./squads/squad-commercial/agents/cs-revops-analyst.md` to understand your full operating parameters. Then:
...
- **Definition:** `./squads/squad-commercial/agents/cs-revops-analyst.md`
...
1. Read the full agent definition: `./squads/squad-commercial/agents/cs-revops-analyst.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-commercial | Invoke: /SINAPSE:agents:cs-revops-analyst"
