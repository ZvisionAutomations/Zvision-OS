...
CRITICAL: Read the agent definition file at `./squads/squad-cloning/agents/cloning-orqx.md` to understand your full operating parameters. Then:
1. Adopt the persona defined in that file (name: "Helix", icon: "🧬")
...
## Agent Reference
- **Agent ID:** cloning-orqx
- **Agent Name:** "Helix"
- **Icon:** "🧬"
- **Squad:** squad-cloning
- **Definition:** `./squads/squad-cloning/agents/cloning-orqx.md`
...
1. Read the full agent definition: `./squads/squad-cloning/agents/cloning-orqx.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-cloning | Invoke: /SINAPSE:agents:cloning-orqx"
