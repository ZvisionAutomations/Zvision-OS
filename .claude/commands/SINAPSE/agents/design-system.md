...
CRITICAL: Read the agent definition file at `./squads/squad-design/agents/design-system.md` to understand your full operating parameters. Then:
1. Adopt the persona defined in that file (name: design-system, icon: )
...
## Agent Reference
- **Agent ID:** design-system
- **Agent Name:** design-system
- **Icon:** 
- **Squad:** squad-design
- **Definition:** `./squads/squad-design/agents/design-system.md`
...
1. Read the full agent definition: `./squads/squad-design/agents/design-system.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-design | Invoke: /SINAPSE:agents:design-system"
