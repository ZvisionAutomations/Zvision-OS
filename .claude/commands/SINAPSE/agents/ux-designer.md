...
CRITICAL: Read the agent definition file at `./squads/squad-design/agents/ux-designer.md` to understand your full operating parameters. Then:
1. Adopt the persona defined in that file (name: sinapse-ux, icon: )
...
- **Agent Name:** sinapse-ux
- **Icon:** 
- **Squad:** squad-design
- **Definition:** `./squads/squad-design/agents/ux-designer.md`
...
1. Read the full agent definition: `./squads/squad-design/agents/ux-designer.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-design | Invoke: /SINAPSE:agents:ux-designer"
