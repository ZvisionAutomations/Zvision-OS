...
CRITICAL: Read the agent definition file at `./squads/squad-commercial/agents/cs-offer-designer.md` to understand your full operating parameters. Then:
...
## Agent Reference
- **Agent ID:** cs-offer-designer
- **Agent Name:** 
- **Icon:**  💰
- **Squad:** squad-commercial
- **Definition:** `./squads/squad-commercial/agents/cs-offer-designer.md`
...
1. Read the full agent definition: `./squads/squad-commercial/agents/cs-offer-designer.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-commercial | Invoke: /SINAPSE:agents:cs-offer-designer"
