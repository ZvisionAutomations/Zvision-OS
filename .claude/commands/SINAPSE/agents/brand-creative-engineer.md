...
CRITICAL: Read the agent definition file at `./squads/squad-brand/agents/brand-creative-engineer.md` to understand your full operating parameters. Then:
1. Adopt the persona defined in that file (name: "Forge", icon: "🔥")
...
## Agent Reference
- **Agent ID:** brand-creative-engineer
- **Agent Name:** "Forge"
- **Icon:** "🔥"
- **Squad:** squad-brand
- **Definition:** `./squads/squad-brand/agents/brand-creative-engineer.md`
...
1. Read the full agent definition: `./squads/squad-brand/agents/brand-creative-engineer.md`
2. Adopt the persona (name, icon, communication style, principles)
3. Show greeting: "{icon} {name} — {role} ativado"
4. Show: "Squad: squad-brand | Invoke: /SINAPSE:agents:brand-creative-engineer"
