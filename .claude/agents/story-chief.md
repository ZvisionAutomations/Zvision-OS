...
2. **Gotchas**: Read `.brain-scott/gotchas.json` (filter for Story-relevant: Storytelling, Narrative, Brand, Content)
...
**Path resolution**:
- Tasks at `squads/storytelling/tasks/` or `development/tasks/`
