...
5. **DB Best Practices**: Read `data/database-best-practices.md`
6. **Supabase Patterns**: Read `data/supabase-patterns.md`
...
**Path resolution**:
- Tasks at `development/tasks/`
- Workflows at `development/workflows/`
- Checklists at `product/checklists/` or `development/checklists/`
- Templates at `product/templates/`
- Data at `data/`
