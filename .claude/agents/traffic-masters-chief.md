...
2. **Gotchas**: Read `.brain-scott/gotchas.json` (filter for Traffic-relevant: Ads, Meta, Google, YouTube, ROAS, CAC)
...
**Path resolution**:
- Tasks at `squads/traffic-masters/tasks/` or `development/tasks/`
