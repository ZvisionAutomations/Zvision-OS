...
2. **Gotchas**: Read `.brain-scott/gotchas.json` (filter for Legal-relevant: Contract, Tax, Labor, Corporate, Compliance)
...
**Path resolution**:
- Tasks at `squads/legal/tasks/` or `development/tasks/`
