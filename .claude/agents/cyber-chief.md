...
2. **Gotchas**: Read `.brain-scott/gotchas.json` (filter for Security-relevant: Security, Vulnerability, Pentest, AppSec)
...
**Path resolution**:
- Tasks at `squads/cybersecurity/tasks/` or `development/tasks/`
