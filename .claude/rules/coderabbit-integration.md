...
wsl bash -c 'cd /mnt/c/.../brain-scott-core && ~/.local/bin/coderabbit --severity CRITICAL,HIGH --auto-fix'

# Manual review
wsl bash -c 'cd /mnt/c/.../brain-scott-core && ~/.local/bin/coderabbit -t uncommitted'

# Prompt-only mode
wsl bash -c 'cd /mnt/c/.../brain-scott-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'
```
