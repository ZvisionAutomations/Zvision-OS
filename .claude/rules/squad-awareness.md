...
| Squad | Capacidade |
|-------|-----------|
| `squad-dev` | 7 agents, 5 tasks, 4 KBs, 3 workflows |
...
|---------|-------|-------------|-----------|
| Codigo, site, landing page, deploy, bug, HTML, CSS, JS, Node | squad-dev | dev-orqx (Forge Prime) | `/dev:agents:dev-orqx` |
...
| Situacao | Squad |
|----------|-------|
| Codigo/site/landing/deploy/bug/HTML/CSS/JS/Node/Vercel | squad-dev |
