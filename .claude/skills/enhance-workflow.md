...
domain_roundtable_map:
  ...
  code_app:
    ...
    agent_files: [agents/architect.md, agents/data-engineer.md, agents/devops.md, agents/ux-design-expert.md]
  ...
  design_brand:
    ...
    agent_files: [Design/agents/design-chief.md, Design/agents/brad-frost.md, Design/agents/marty-neumeier.md, agents/ux-design-expert.md]
  ...
  squad_workflow:
    ...
    agents: [process-auditor, squad-architect, qa, devops]
    agent_files: [squad-creator/agents/process-auditor.md, squad-creator/agents/squad-architect.md, agents/qa.md, agents/devops.md]
...
**Spawn agent** com prompt incluindo Context Preamble.
...
```
Você é Quinn, o QA. Leia seu agent file em:
.claude/agents/qa.md
