...
The manifest is parsed by `domain-loader.js` (`core/synapse/domain/domain-loader.js`) on every prompt.
...
| `core/synapse/domain/domain-loader.js` | Manifest parser + domain file loader |
