...
SYNAPSE processes rules through an 8-layer pipeline executed sequentially on every prompt. Each layer has a specific purpose, trigger condition, and priority level. The engine orchestrator (`core/synapse/engine.js`) chains all layers and the output formatter produces the final `<synapse-rules>` XML block.
...
| **Source** | Auto-generated from `constitution.md` via `generate-constitution.js` |
| **Implementation** | `core/synapse/layers/l0-constitution.js` |
...
| **Implementation** | `core/synapse/layers/l1-global.js` |
...
| **Implementation** | `core/synapse/layers/l2-agent.js` |

**Agents covered:** dev, qa, architect, pm, po, sm, devops, analyst, data-engineer, ux (ux-design-expert), brain-scott-master, squad-creator.
...
| **Implementation** | `core/synapse/layers/l3-workflow.js` |
...
| **Implementation** | `core/synapse/layers/l4-task.js` |
...
| **Implementation** | `core/synapse/layers/l5-squad.js` |
...
| **Implementation** | `core/synapse/layers/l6-keyword.js` |
...
| **Implementation** | `core/synapse/layers/l7-star-command.js` |
...
| File | Purpose |
|------|---------|
| `core/synapse/engine.js` | SynapseEngine orchestrator |
| `core/synapse/layers/l0-constitution.js` | L0 processor |
| `core/synapse/layers/l1-global.js` | L1 processor |
| `core/synapse/layers/l2-agent.js` | L2 processor |
| `core/synapse/layers/l3-workflow.js` | L3 processor |
| `core/synapse/layers/l4-task.js` | L4 processor |
| `core/synapse/layers/l5-squad.js` | L5 processor |
| `core/synapse/layers/l6-keyword.js` | L6 processor |
| `core/synapse/layers/l7-star-command.js` | L7 processor |
| `core/synapse/layers/layer-processor.js` | Abstract base class |
| `core/synapse/output/formatter.js` | XML formatter + token budget |
