...
|------------|-------|-------------|
| @mind-cloner | `/squad:mind-cloner` | Mind cloning, DNA extraction |
| @process-auditor | `/squad:process-auditor` | Process validation, workflow audit |
...
[Invokes @mind-cloner for each mind]
