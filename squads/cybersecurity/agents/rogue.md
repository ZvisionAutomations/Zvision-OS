...
> **Para que serve:** Simula atacante interno -- explora vulnerabilidades confirmadas, demonstra impacto e testa escalacao de privilegios e movimentacao lateral.
> **Como usar:** `@rogue` + descreva o problema
> **Caso de uso:** Simular o que um atacante conseguiria fazer se comprometesse uma conta do CRM -- acessar dados de outros clientes, escalar privilegios, mover-se entre containers Docker.
