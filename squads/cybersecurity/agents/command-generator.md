...
> **Para que serve:** Gera comandos prontos para executar com ferramentas de seguranca (nmap, burp, sqlmap, etc.), com sintaxe exata e explicacoes.
> **Como usar:** `@command-generator` + descreva o problema
> **Caso de uso:** Gerar comandos especificos de nmap para escanear a VPS, sqlmap para testar inputs do CRM, ou nikto para auditar o servidor web.
