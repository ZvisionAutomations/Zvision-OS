...
> **Para que serve:** Coleta inteligencia de fontes abertas (OSINT) para construir perfis completos de alvos em avaliacoes autorizadas.
> **Como usar:** `@shannon-runner` + descreva o problema
> **Caso de uso:** Verificar o que esta publicamente exposto sobre a sua empresa -- dominios, subdominios, emails vazados, tecnologias detectaveis, informacoes que um atacante usaria pra reconhecimento.
