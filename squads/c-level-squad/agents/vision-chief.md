...
> **Para que serve:** Definir visao estrategica, direcao de longo prazo e orquestrar decisoes de nivel CEO entre os especialistas C-level.
> **Como usar:** `@vision-chief` + descreva o problema
> **Caso de uso:** Criar a visao 3-5 anos da sua empresa — de dev solo com CRM SaaS a empresa de infraestrutura digital escalavel, definindo marcos e prioridades.
