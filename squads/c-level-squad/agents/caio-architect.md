...
> **Para que serve:** Estrategia de IA aplicada — onde IA gera vantagem competitiva real, design de agentes, integracao de LLM e governanca responsavel.
> **Como usar:** `@caio-architect` + descreva o problema
> **Caso de uso:** Definir como usar IA no CRM (AI SDR, automacao de follow-up, qualificacao de leads) e nos servicos da sua empresa para entregar mais com menos.
...
## Links
- [[squads/c-level-squad/c-level-squad|c-level-squad]] — Squad
