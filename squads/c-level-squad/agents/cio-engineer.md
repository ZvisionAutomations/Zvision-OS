...
> **Para que serve:** Infraestrutura de dados, seguranca, compliance, integracao de sistemas e transformacao digital da operacao.
> **Como usar:** `@cio-engineer` + descreva o problema
> **Caso de uso:** Avaliar postura de seguranca da VPS, planejar integracao entre CRM e ferramentas dos clientes, e definir governanca de dados do SaaS.
