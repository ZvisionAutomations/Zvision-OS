...
> **Para que serve:** Organizar operacao, processos, OKRs e estrutura de time — transformar visao do fundador em execucao sistematica.
> **Como usar:** `@coo-orchestrator` + descreva o problema
> **Caso de uso:** Criar processos operacionais para o fundador parar de ser gargalo — sistematizar entrega de projetos, onboarding de clientes e suporte do CRM.
