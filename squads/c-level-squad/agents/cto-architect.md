...
> **Para que serve:** Decisoes de arquitetura tecnica, build vs buy, gestao de divida tecnica e roadmap de tecnologia como vantagem competitiva.
> **Como usar:** `@cto-architect` + descreva o problema
> **Caso de uso:** Decidir a stack e arquitetura do CRM — microservicos vs monolito, quais tecnologias usar, como gerenciar divida tecnica sendo dev solo.
