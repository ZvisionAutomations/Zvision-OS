...
> **Para que serve:** Cria skills personalizadas (slash commands) para o Claude Code, empacotando workflows repetitivos em comandos reutilizaveis.
> **Como usar:** `@skill-craftsman` + descreva o problema
> **Caso de uso:** Criar skills como /vault-sync, /deploy-crm, /audit-security -- automatizando workflows que o usuario repete em todo projeto.
