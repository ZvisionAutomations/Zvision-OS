...
> **Para que serve:** Otimiza settings.json, permissoes, sandbox e configuracoes do Claude Code para maximo desempenho e seguranca.
> **Como usar:** `@config-engineer` + descreva o problema
> **Caso de uso:** Auditar e otimizar as permissoes do Claude Code -- garantir que o vault tem acesso de escrita, que o sandbox esta correto e que as configs globais/projeto estao alinhadas.
