...
> **Para que serve:** Monitora o roadmap do Claude Code e avalia novas features para adocao rapida, mantendo o setup sempre atualizado.
> **Como usar:** `@roadmap-sentinel` + descreva o problema
> **Caso de uso:** Verificar se ha features novas do Claude Code (agent teams, sub-agents, novo MCP) que podem ser adotadas para melhorar o workflow do usuario.
