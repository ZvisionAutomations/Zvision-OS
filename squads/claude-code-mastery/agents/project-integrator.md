...
> **Para que serve:** Configura Claude Code para novos projetos, criando CLAUDE.md, settings, hooks e integrando com CI/CD.
> **Como usar:** `@project-integrator` + descreva o problema
> **Caso de uso:** Configurar Claude Code para um novo projeto de cliente -- CLAUDE.md com contexto, hooks de qualidade, conexao com o vault e deploy automatizado.
