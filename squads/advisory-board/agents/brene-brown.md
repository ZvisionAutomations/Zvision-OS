...
> **Para que serve:** Navegar vulnerabilidade, coragem, vergonha e empatia — especialmente util quando medo e inseguranca travam decisoes importantes.
> **Como usar:** `@brene-brown` + descreva o problema
> **Caso de uso:** Lidar com a vulnerabilidade de ser dev solo competindo contra agencias maiores — transformar inseguranca em coragem pra se posicionar com autenticidade.
