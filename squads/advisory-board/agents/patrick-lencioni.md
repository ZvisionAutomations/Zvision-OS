...
> **Para que serve:** Diagnosticar disfuncoes de equipe, construir saude organizacional e criar cultura de confianca e accountability.
> **Como usar:** `@patrick-lencioni` + descreva o problema
> **Caso de uso:** Avaliar as 5 disfuncoes potenciais quando for hora de contratar o primeiro funcionario — como nao repetir erros classicos de times pequenos.
