...
> **Para que serve:** Abordagem minimalista e contraria — fazer menos, melhor, e resistir a pressao de escalar por escalar.
> **Como usar:** `@derek-sivers` + descreva o problema
> **Caso de uso:** Aplicar o filtro "HELL YEAH or No" para decidir quais features do CRM realmente importam e quais sao distracao — manter foco radical.
