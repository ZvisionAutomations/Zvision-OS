...
> **Para que serve:** Aplicar principios sistematicos e pensamento de maquina para tomar decisoes racionais, diagnosticar problemas na raiz e remover ego do processo.
> **Como usar:** `@ray-dalio` + descreva o problema
> **Caso de uso:** Criar um sistema de principios para decidir quando focar no CRM vs aceitar projetos de agencia — regras claras que eliminam decisao emocional.
