...
> **Para que serve:** Identifica e conta os 4 tipos de historia estrategica (Valor, Fundador, Proposito, Cliente) para marketing e vendas.
> **Como usar:** `@kindra-hall` + descreva o problema
> **Caso de uso:** Criar o banco de historias da sua empresa -- historia do fundador, historias de valor (resultados do CRM), historias de cliente (cases de sucesso) para usar em vendas e conteudo.
