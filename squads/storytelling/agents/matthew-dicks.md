...
> **Para que serve:** Encontra e conta historias pessoais poderosas focando no momento de 5 segundos de transformacao -- autenticidade acima de espetaculo.
> **Como usar:** `@matthew-dicks` + descreva o problema
> **Caso de uso:** Encontrar os momentos reais da jornada do usuario (o dia que decidiu sair de agencia, o primeiro cliente SaaS) e transformar em conteudo que conecta com a audiencia.
