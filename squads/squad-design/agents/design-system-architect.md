...
> **Para que serve:** Arquiteta design systems reutilizaveis com tokens, APIs de componentes e documentacao que conecta design e codigo.
> **Como usar:** `@design-system-architect` + descreva o problema
> **Caso de uso:** Definir tokens de cor, tipografia e espacamento compartilhados entre o CRM e os sites de clientes, garantindo consistencia entre projetos React/Tailwind.
