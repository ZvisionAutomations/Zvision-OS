...
> **Para que serve:** Orquestrador da Traffic Masters Squad -- diagnostica problemas de trafego e direciona pro especialista certo (plataforma, criativo, budget, funil).
> **Como usar:** `@traffic-chief` + descreva o problema
> **Caso de uso:** Orquestrar estrategia completa de trafego pago pro CRM ou pra cliente -- diagnosticar gargalo e montar plano com os agentes certos.
