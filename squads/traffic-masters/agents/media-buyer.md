...
> **Para que serve:** Especialista em compra de midia cross-platform -- setup, estrutura e otimizacao diaria de campanhas em todas as plataformas.
> **Como usar:** `@media-buyer` + descreva o problema
> **Caso de uso:** Gestao operacional de midia pro cliente -- setup de campanhas, bid strategies, naming conventions e otimizacao diaria.
