...
> **Para que serve:** Detetive de performance criativa -- analisa POR QUE certos criativos vencem e traduz padroes em briefs acionaveis.
> **Como usar:** `@creative-analyst` + descreva o problema
> **Caso de uso:** Avaliar performance dos criativos de ads do cliente -- identificar padroes vencedores e gerar briefs pra proxima rodada.
