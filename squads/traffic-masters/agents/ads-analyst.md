...
> **Para que serve:** Auditor forense de contas de anuncio -- encontra gasto desperdicado, problemas estruturais e oportunidades perdidas.
> **Como usar:** `@ads-analyst` + descreva o problema
> **Caso de uso:** Analisar metricas de campanha do cliente -- auditoria completa da conta com achados priorizados e acoes recomendadas.
