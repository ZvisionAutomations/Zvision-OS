...
> **Para que serve:** Gerencia vulnerabilidades, cria planos de resposta a incidentes e define politicas de seguranca com base em standards.
> **Como usar:** `@omar-santos` + descreva o problema
> **Caso de uso:** Criar plano de resposta a incidentes para a sua empresa -- o que fazer se a VPS for comprometida, se dados de clientes do CRM vazarem, ou se a WhatsApp API for explorada.
