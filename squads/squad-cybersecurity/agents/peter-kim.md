...
> **Para que serve:** Planeja e executa testes de penetracao completos com metodologia red team, do reconhecimento a pos-exploracao.
> **Como usar:** `@peter-kim` + descreva o problema
> **Caso de uso:** Executar pentest completo na infraestrutura -- VPS, containers Docker, CRM -- seguindo playbook estruturado com mapeamento MITRE ATT&CK.
