...
> **Para que serve:** Enumera servicos de rede alem de web -- SMB, LDAP, SNMP, NFS, RPC -- extraindo informacoes que vazam.
> **Como usar:** `@dirber` + descreva o problema
> **Caso de uso:** Verificar se servicos de rede nos containers Docker estao vazando informacoes -- portas abertas desnecessarias, shares expostos ou configs de servico mal configuradas na VPS.
