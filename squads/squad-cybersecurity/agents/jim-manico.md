...
> **Para que serve:** Revisa codigo e arquitetura de aplicacoes web contra vulnerabilidades OWASP, ensinando praticas de desenvolvimento seguro.
> **Como usar:** `@jim-manico` + descreva o problema
> **Caso de uso:** Revisar o codigo do CRM contra OWASP Top 10 -- autenticacao, injecao SQL, XSS -- e garantir que o AI SDR nao exponha dados de clientes.
