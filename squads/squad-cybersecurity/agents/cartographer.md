...
> **Para que serve:** Mapeia superficie de ataque, topologia de rede e pegada digital de um alvo sem explorar -- apenas ilumina o terreno.
> **Como usar:** `@cartographer` + descreva o problema
> **Caso de uso:** Mapear toda a superficie de ataque da infra -- portas abertas na VPS, servicos expostos nos containers Docker, subdominios, e pontos de entrada do CRM e WhatsApp API.
