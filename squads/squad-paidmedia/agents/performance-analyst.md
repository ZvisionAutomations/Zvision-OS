...
> **Para que serve:** Cerebro de dados da squad -- transforma dados brutos de campanha em insights acionaveis com dashboards e KPIs.
> **Como usar:** `@performance-analyst` + descreva o problema
> **Caso de uso:** Dashboard de performance completo pro cliente -- metricas de impressao ate receita, com significancia estatistica e recomendacoes.
