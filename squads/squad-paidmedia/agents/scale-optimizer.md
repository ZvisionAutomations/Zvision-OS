...
> **Para que serve:** Especialista em escalar campanhas -- aumenta budget sem quebrar eficiencia, respeitando curvas de rendimento decrescente.
> **Como usar:** `@scale-optimizer` + descreva o problema
> **Caso de uso:** Otimizar CPA ao escalar budget de campanha do cliente -- expansao sistematica de combinacoes vencedoras mantendo eficiencia.
