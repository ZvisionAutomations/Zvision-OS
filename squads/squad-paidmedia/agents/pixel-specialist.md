...
> **Para que serve:** Especialista em tracking e atribuicao -- pixels, Conversion API, UTMs e navegacao no cenario de privacidade (iOS 14.5+).
> **Como usar:** `@pixel-specialist` + descreva o problema
> **Caso de uso:** Configurar pixel e tracking no site do cliente -- setup completo de eventos, server-side tracking e modelo de atribuicao.
