...
> **Para que serve:** Calcula Customer Lifetime Value, segmenta clientes por valor real e desafia a ideia de que todos os clientes sao iguais.
> **Como usar:** `@peter-fader` + descreva o problema
> **Caso de uso:** Calcular o CLV dos clientes do CRM SaaS, identificar quais clientes geram mais receita recorrente e focar retencao nos que realmente importam.
