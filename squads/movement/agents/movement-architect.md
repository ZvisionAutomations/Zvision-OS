...
> **Para que serve:** Projetar a arquitetura invisivel que sustenta movimentos — topologia de comunidade, escadas de engajamento, rituais e governanca.
> **Como usar:** `@movement-architect` + descreva o problema
> **Caso de uso:** Desenhar a estrutura da comunidade de dev solos builders — niveis de participacao, rituais semanais, como membros sobem de observadores a evangelistas.
