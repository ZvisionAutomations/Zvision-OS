...
> **Para que serve:** Medir se o movimento esta gerando mudanca real ou so barulho — frameworks de impacto, saude da comunidade e prova social.
> **Como usar:** `@analista-de-impacto` + descreva o problema
> **Caso de uso:** Definir metricas pra saber se o movimento de builders esta funcionando — nao so likes, mas impacto real: membros ativos, projetos lancados, receita gerada.
