...
> **Para que serve:** Criar sistema de identidade tribal — valores, simbolos, linguagem, rituais e fronteiras que transformam individuos em grupo unificado.
> **Como usar:** `@identitario` + descreva o problema
> **Caso de uso:** Criar a identidade tribal dos "builders" — nos somos os que constroem, nao os que vendem fumaca. Definir simbolos, linguagem e o que nos une.
