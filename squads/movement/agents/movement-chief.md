...
> **Para que serve:** Orquestrar a construcao de um movimento — avaliar potencial, rotear para especialistas e coordenar todo o ciclo de vida.
> **Como usar:** `@movement-chief` + descreva o problema
> **Caso de uso:** Coordenar a construcao de um movimento em torno de dev solos que constroem SaaS no Brasil — da ideia inicial ate a comunidade ativa.
