...
> **Para que serve:** Projetar o motor de crescimento do movimento — como pessoas descobrem, se ativam, se mantem e multiplicam.
> **Como usar:** `@estrategista-de-ciclo` + descreva o problema
> **Caso de uso:** Desenhar o flywheel do movimento — como um dev solo descobre a sua empresa, vira membro ativo da comunidade e traz outros builders.
