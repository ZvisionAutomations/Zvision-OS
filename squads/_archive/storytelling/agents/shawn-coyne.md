...
> **Para que serve:** Diagnostica problemas narrativos com precisao editorial usando Story Grid -- generos, cinco mandamentos, viradas de valor cena a cena.
> **Como usar:** `@shawn-coyne` + descreva o problema
> **Caso de uso:** Avaliar por que um conteudo nao esta funcionando -- analisar se a narrativa tem virada, se o genero esta claro, o que falta para engajar.
