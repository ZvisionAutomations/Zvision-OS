...
> **Para que serve:** Cria apresentacoes persuasivas usando Sparkline ("o que e" vs "o que poderia ser"), transformando dados em narrativa visual que move a acao.
> **Como usar:** `@nancy-duarte` + descreva o problema
> **Caso de uso:** Montar apresentacao de vendas do CRM para reunioes com clientes -- alternando entre o problema atual deles e a visao de futuro com a solucao sua empresa.
