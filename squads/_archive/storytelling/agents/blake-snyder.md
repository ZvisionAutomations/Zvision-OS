...
> **Para que serve:** Estrutura narrativas com o Beat Sheet de 15 pontos (Save the Cat), ideal para roteiros, apresentacoes e pitches com estrutura comercial.
> **Como usar:** `@blake-snyder` + descreva o problema
> **Caso de uso:** Estruturar apresentacao de vendas do CRM como beat sheet -- abertura que prende, build-up do problema, virada com a solucao, finale com CTA.
