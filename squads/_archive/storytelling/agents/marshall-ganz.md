...
> **Para que serve:** Constroi narrativa publica com o framework "Eu, Nos, Agora" para mobilizar comunidades e criar movimento em torno de uma causa.
> **Como usar:** `@marshall-ganz` + descreva o problema
> **Caso de uso:** Criar narrativa de movimento em torno da sua empresa -- "eu" (a historia do usuario), "nos" (devs solo que constroem negocios), "agora" (por que adotar o CRM hoje).
