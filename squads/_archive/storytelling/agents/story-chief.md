...
> **Para que serve:** Orquestra projetos de narrativa, diagnosticando o desafio e roteando para os especialistas de storytelling certos.
> **Como usar:** `@story-chief` + descreva o problema
> **Caso de uso:** Coordenar a construcao da narrativa da marca sua empresa -- historia do fundador, pitch de vendas, roteiros de conteudo -- distribuindo entre os especialistas.
