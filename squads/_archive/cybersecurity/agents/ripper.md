...
> **Para que serve:** Quebra hashes de senha, analisa politicas de credenciais e constroi wordlists direcionadas para avaliar seguranca de autenticacao.
> **Como usar:** `@ripper` + descreva o problema
> **Caso de uso:** Avaliar a forca das senhas dos usuarios do CRM, testar se a politica de senha e robusta e verificar se hashes armazenados no banco sao seguros.
