...
> **Para que serve:** Descobre diretorios, arquivos e endpoints ocultos em aplicacoes web atraves de brute-force e fuzzing inteligente.
> **Como usar:** `@busterer` + descreva o problema
> **Caso de uso:** Varrer o CRM (seu-crm.exemplo.com) em busca de paineis admin expostos, arquivos de backup, configs vazadas ou endpoints de API nao documentados.
