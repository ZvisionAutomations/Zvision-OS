...
> **Para que serve:** Realiza testes de penetracao com foco em mobile e abordagem pratica e acessivel, incluindo desenvolvimento de exploits.
> **Como usar:** `@georgia-weidman` + descreva o problema
> **Caso de uso:** Testar a seguranca da integracao do CRM com WhatsApp API e verificar se as APIs expostas na VPS sao vulneraveis a exploits conhecidos.
