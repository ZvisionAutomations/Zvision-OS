...
> **Para que serve:** Testa todos os inputs de uma aplicacao (parametros, headers, cookies) para encontrar onde ela quebra ou vaza dados.
> **Como usar:** `@fuzzer` + descreva o problema
> **Caso de uso:** Testar os formularios e APIs do CRM contra injecao SQL, XSS e manipulacao de parametros -- especialmente nos endpoints do AI SDR e pipeline de vendas.
