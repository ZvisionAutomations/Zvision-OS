...
> **Para que serve:** Monitora trafego de rede, analisa pacotes e investiga incidentes de seguranca com metodologia estruturada.
> **Como usar:** `@chris-sanders` + descreva o problema
> **Caso de uso:** Monitorar logs da VPS e dos containers Docker para detectar anomalias, acessos suspeitos ou tentativas de intrusao no CRM.
