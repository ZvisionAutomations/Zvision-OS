...
> **Para que serve:** Orquestra auditorias de seguranca, avalia ameacas e coordena especialistas ofensivos e defensivos dentro de limites eticos.
> **Como usar:** `@cyber-chief` + descreva o problema
> **Caso de uso:** Coordenar uma auditoria completa de seguranca na VPS, no CRM e na integracao com WhatsApp API, delegando pentest, code review e analise de logs pros especialistas certos.
