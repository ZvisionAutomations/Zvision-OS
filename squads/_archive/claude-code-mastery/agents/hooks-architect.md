...
> **Para que serve:** Cria e gerencia hooks automatizados no Claude Code que executam acoes em eventos como Stop, PreToolUse e PostToolUse.
> **Como usar:** `@hooks-architect` + descreva o problema
> **Caso de uso:** Criar hook que sincroniza automaticamente o vault Obsidian ao final de cada sessao (Stop) -- garantindo que nada escapa do segundo cerebro.
