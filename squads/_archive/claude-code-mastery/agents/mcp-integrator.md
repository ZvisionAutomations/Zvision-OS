...
> **Para que serve:** Integra MCP servers ao Claude Code, conectando ferramentas externas como Playwright, Notion, Docker e APIs ao workflow.
> **Como usar:** `@mcp-integrator` + descreva o problema
> **Caso de uso:** Configurar e otimizar MCPs do Docker (EXA, Context7, Apify) e Playwright para pesquisa, scraping e automacao de browser direto do Claude Code.
