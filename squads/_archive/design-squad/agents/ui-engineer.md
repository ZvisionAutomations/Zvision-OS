...
> **Para que serve:** Implementa componentes UI em codigo de producao com React, Tailwind e foco em responsividade, acessibilidade e performance.
> **Como usar:** `@ui-engineer` + descreva o problema
> **Caso de uso:** Implementar os componentes do CRM (pipeline drag-and-drop, cards de lead, modais de interacao) em React/Tailwind pixel-perfect.
