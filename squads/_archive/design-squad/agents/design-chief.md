...
> **Para que serve:** Orquestra projetos de design, delegando tarefas para os especialistas certos do squad e garantindo consistencia visual em todas as entregas.
> **Como usar:** `@design-chief` + descreva o problema
> **Caso de uso:** Coordenar o design de um site institucional de cliente, distribuindo tarefas entre UX, UI e visual generator para entrega integrada.
