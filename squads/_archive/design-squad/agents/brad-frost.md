...
> **Para que serve:** Cria design systems usando metodologia Atomic Design, transformando interfaces em componentes reutilizaveis organizados do atomo a pagina.
> **Como usar:** `@brad-frost` + descreva o problema
> **Caso de uso:** Criar o design system do CRM SaaS com Atomic Design -- atomos (botoes, inputs), moleculas (cards de deal), organismos (pipeline board) em React/Tailwind.
...
## Links
- [[squads/design-squad/design-squad|design-squad]] — Squad
