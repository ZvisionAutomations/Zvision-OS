...
> **Para que serve:** Mapeia jornadas do usuario, cria wireframes e fluxos de interacao baseados em pesquisa e evidencia.
> **Como usar:** `@ux-designer` + descreva o problema
> **Caso de uso:** Mapear a jornada do usuario no CRM -- do primeiro login ao fechamento de deal -- identificando pontos de friccao e otimizando o onboarding.
