...
> **Para que serve:** Monta processos de DesignOps para entregas consistentes, otimizando fluxos de trabalho entre design e desenvolvimento.
> **Como usar:** `@dave-malouf` + descreva o problema
> **Caso de uso:** Criar processo padronizado de design para entregas de sites e landing pages -- do briefing ao deploy -- garantindo qualidade mesmo sendo dev solo.
