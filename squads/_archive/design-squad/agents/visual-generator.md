...
> **Para que serve:** Gera assets visuais, prompts de imagem, thumbnails, icones e conceitos de identidade visual alinhados a marca.
> **Como usar:** `@visual-generator` + descreva o problema
> **Caso de uso:** Gerar assets visuais para landing pages de clientes -- hero images, icones customizados, thumbnails para redes sociais alinhados ao branding.
