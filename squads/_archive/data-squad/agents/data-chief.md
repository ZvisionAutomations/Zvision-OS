...
> **Para que serve:** Orquestra analise de dados, roteando perguntas para o especialista certo e consolidando insights acionaveis.
> **Como usar:** `@data-chief` + descreva o problema
> **Caso de uso:** Coordenar analise completa do CRM -- metricas de conversao, CLV dos clientes, churn, growth -- delegando cada tema pro especialista adequado.
