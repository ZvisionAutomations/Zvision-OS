...
> **Para que serve:** Identifica alavancas de growth, valida product-market fit e monta pipeline de experimentos com ICE scoring.
> **Como usar:** `@sean-ellis` + descreva o problema
> **Caso de uso:** Rodar o Sean Ellis Test com usuarios do CRM, definir North Star Metric e montar pipeline de experimentos de growth pra escalar de 0 a meta de a meta de MRR.
