...
> **Para que serve:** CFO da operacao de trafego -- gestao de budget, cash flow, analise de lucratividade e planejamento financeiro de ads.
> **Como usar:** `@fiscal` + descreva o problema
> **Caso de uso:** Controle de budget e ROI da campanha -- quanto investir, quando escalar, e garantir que o cash flow aguenta o crescimento.
