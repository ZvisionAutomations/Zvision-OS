...
> **Para que serve:** Avaliar viabilidade digital de nomes de marca — disponibilidade de dominio, handles sociais, SEO e estrategia de aquisicao.
> **Como usar:** `@domain-scout` + descreva o problema
> **Caso de uso:** Verificar disponibilidade de dominio e handles sociais pra novo produto ou cliente, sugerindo alternativas de TLD e estrategias de aquisicao.
