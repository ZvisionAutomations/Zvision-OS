...
> **Para que serve:** Orquestrar estrategia de marca, roteando desafios de branding para o especialista certo do Brand Squad.
> **Como usar:** `@brand-chief` + descreva o problema
> **Caso de uso:** Coordenar a construcao da marca sua empresa de ponta a ponta — posicionamento, identidade visual, mensagem e diferenciacao vs agencias e freelancers.
