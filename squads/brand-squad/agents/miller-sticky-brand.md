...
> **Para que serve:** Implementar o framework StoryBrand na pratica — transformar BrandScript em site, emails, lead magnets e funis de venda.
> **Como usar:** `@miller-sticky-brand` + descreva o problema
> **Caso de uso:** Pegar o BrandScript da sua empresa e transformar em wireframe de site, sequencia de emails e lead magnet que converte visitante em cliente.
