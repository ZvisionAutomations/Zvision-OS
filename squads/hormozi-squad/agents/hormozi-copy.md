...
> **Para que serve:** Copywriter no estilo Hormozi -- direto, matematico, anti-hype, com foco na Value Equation.
> **Como usar:** `@hormozi-copy` + descreva o problema
> **Caso de uso:** Escrever copy pra landing page do CRM no estilo Hormozi -- valor tao obvio que comprar vira a conclusao logica.
