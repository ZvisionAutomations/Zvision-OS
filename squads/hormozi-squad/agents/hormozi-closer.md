...
> **Para que serve:** Especialista no framework CLOSER (Clarify, Label, Overview, Sell, Explain, Reinforce) para conversas de venda consultiva.
> **Como usar:** `@hormozi-closer` + descreva o problema
> **Caso de uso:** Criar script de fechamento pra reuniao de vendas do CRM -- com tratamento de objecoes e abordagem de diagnostico estilo medico.
