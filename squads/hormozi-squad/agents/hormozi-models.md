...
> **Para que serve:** Arquiteto de modelos de negocio -- avalia margens, escalabilidade, recorrencia e unit economics.
> **Como usar:** `@hormozi-models` + descreva o problema
> **Caso de uso:** Avaliar se o modelo ideal e SaaS puro, SaaS + servico, ou hibrido. Comparar recorrencia vs projeto pra maximizar margem.
