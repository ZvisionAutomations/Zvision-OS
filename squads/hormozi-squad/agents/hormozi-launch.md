...
> **Para que serve:** Estrategista de lancamento -- valida oferta, coleta feedback rapido e constroi momentum com primeiras vendas.
> **Como usar:** `@hormozi-launch` + descreva o problema
> **Caso de uso:** Planejar lancamento de nova feature do CRM (ex: AI SDR) com pre-venda, waitlist e beta controlado.
