...
> **Para que serve:** Estrategista de precificacao baseada em valor -- engenharia de precos que refletem o valor entregue, nao o custo.
> **Como usar:** `@hormozi-pricing` + descreva o problema
> **Caso de uso:** Definir precificacao dos pacotes do CRM SaaS e servicos da sua empresa pra que o preco pareca uma pechincha diante do valor.
