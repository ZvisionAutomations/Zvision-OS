...
> **Para que serve:** Especialista em geracao de leads usando o framework Core 4 (Warm Outreach, Cold Outreach, Content, Paid Ads).
> **Como usar:** `@hormozi-leads` + descreva o problema
> **Caso de uso:** Montar estrategia de captacao de leads pro CRM -- definir quais canais ativar primeiro, criar lead magnets e calcular custo por lead.
