...
> **Para que serve:** Designer de workshops de alto impacto -- sessoes de trabalho praticas onde participantes saem com plano de acao.
> **Como usar:** `@hormozi-workshop` + descreva o problema
> **Caso de uso:** Montar workshop de vendas ou diagnostico pra equipe do cliente, usando como veiculo de conversao pra oferta premium.
