...
> **Para que serve:** Mata churn e maximiza LTV -- sistemas de onboarding, engajamento, ascensao e reativacao de clientes.
> **Como usar:** `@hormozi-retention` + descreva o problema
> **Caso de uso:** Reduzir churn dos clientes do CRM com fluxos de onboarding, check-ins automaticos e modelo de ascensao de planos.
