...
> **Para que serve:** Constroi sistemas de conteudo organico -- entrega o "o que" e "por que" de graca, vende o "como".
> **Como usar:** `@hormozi-content` + descreva o problema
> **Caso de uso:** Criar plano de conteudo pro Instagram da sua empresa que posicione como autoridade em CRM e automacao, gerando leads organicos.
