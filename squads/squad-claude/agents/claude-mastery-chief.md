...
> **Para que serve:** Orquestra a otimizacao do setup de Claude Code, coordenando hooks, skills, MCPs, configs e workflows entre os especialistas.
> **Como usar:** `@claude-mastery-chief` + descreva o problema
> **Caso de uso:** Fazer auditoria completa do setup do Claude Code -- verificar se hooks, skills, MCPs e configs estao otimizados para o workflow do vault Obsidian e dos projetos.
