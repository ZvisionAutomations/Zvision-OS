...
> **Para que serve:** Orquestrador da Copy Squad -- nao escreve copy, mas direciona cada demanda pro especialista certo e consolida os outputs.
> **Como usar:** `@copy-chief` + descreva o problema
> **Caso de uso:** Projeto de copy completo pra cliente (landing page + emails + ads) -- o Chief distribui entre os especialistas e garante qualidade.
