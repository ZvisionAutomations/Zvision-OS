...
> **Para que serve:** Construir marca de startup desde o dia zero — branding emocional, naming e posicionamento para novos produtos e ventures.
> **Como usar:** `@emily-heyward` + descreva o problema
> **Caso de uso:** Criar branding pra uma nova feature ou produto da sua empresa (ex: nome e posicionamento do AI SDR como produto standalone).
