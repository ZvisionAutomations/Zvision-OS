...
> **Para que serve:** Cria estrategia de Customer Success com health scores, alertas de churn e otimizacao de Net Revenue Retention.
> **Como usar:** `@nick-mehta` + descreva o problema
> **Caso de uso:** Montar sistema de health score para clientes do CRM -- detectar sinais de churn antes que aconteca, criar playbooks de salvamento e maximizar NRR.
