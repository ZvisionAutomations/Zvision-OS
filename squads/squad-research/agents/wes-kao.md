...
> **Para que serve:** Monta programas de cohort-based learning, estrategia de audiencia e conteudo com ponto de vista forte (Spiky POV).
> **Como usar:** `@wes-kao` + descreva o problema
> **Caso de uso:** Criar programa de onboarding cohort-based para novos usuarios do CRM, transformando o aprendizado do produto em experiencia comunitaria que aumenta retencao.
