...
> **Para que serve:** Define metricas acionaveis e KPIs que realmente importam, eliminando metricas de vaidade com o framework See-Think-Do-Care.
> **Como usar:** `@avinash-kaushik` + descreva o problema
> **Caso de uso:** Definir os KPIs do CRM que importam de verdade -- CAC, LTV, taxa de conversao por etapa do pipeline -- e montar dashboard que gera decisao, nao decoracao.
